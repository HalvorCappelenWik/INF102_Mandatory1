...
import INF102.Mandatory1.system.RobotStateManager;
...
public class Robot implements Comparable<Robot> {
	 ...
	 * Once a move command is given the Robot will immediately find the optimal
	 * route to the job location.
	 * Robots always move in a straight line between the current location and their
	 * target.
	 * 
	 * runtime: O(log M)
	 * 
	 ...
	 * 
	 * If robot is moving towards a job or is waiting for a job to complete that job
	 * will be returned,
	 * if robot is either moving to a point not related to a job or waiting for
	 * orders null is returned
	 * 
	 * runtime: O(1)
	 * 
	 * @return null if robot is free, otherwise the job this robot is working
	 *         towards.
	 * 
	 */
	public Job getJob() {
