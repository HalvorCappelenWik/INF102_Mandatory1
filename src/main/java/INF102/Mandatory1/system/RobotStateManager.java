package INF102.Mandatory1.system;
 ...
 * A centralized system keeps track of all robots and their positions and which
 * Job they are doing next.
 * 
...
public interface RobotStateManager {
	 ...
	 * to this Job until the Job is completed or the Robot receives a different
	 * command
	 */
